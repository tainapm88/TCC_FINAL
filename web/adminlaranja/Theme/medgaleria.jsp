          	...
          	<hr>
                <form action="#" method="post" class="form-inline">
                    <div class="form-group mb-12">
                        <input type="text" class="form-control-plaintext"  name="txtFiltro" placeholder="Nome do medicamento">
                    </div>
                    
                    <button type="submit" class="btn btn-primary mb-12">Pesquisar</button>
                  </form>
				<div class="row mt">
